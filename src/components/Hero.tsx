          ...
          <div className="space-y-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <a 
                ...
                target="_blank" 
                rel="noopener noreferrer"
                className="w-full h-14 border-blue-500/50 text-blue-400 hover:bg-blue-500/10 hover:border-blue-500 h-11 px-8 rounded-md inline-flex items-center justify-center text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50"
              >
                Falar no WhatsApp
              </a>
            </div>
