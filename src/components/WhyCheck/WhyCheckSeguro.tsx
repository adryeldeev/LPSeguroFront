...
const WhyCheckSeguro = () => {
  return (
    <div className="flex flex-col gap-6 max-w-md w-full m-5">
      {/* Título: maior no desktop, menor no mobile */}
      <h2 className="text-xl sm:text-3xl md:text-3xl lg:text-3xl font-bold text-black text-center">
  Por que confiar na <span className="text-[#FFD700]">4S Seguro</span>?
</h2>

      {/* Itens: texto menor no mobile */}
      <div className="flex items-start gap-3">
        <FaBalanceScale className="text-[#FFD700] text-xl sm:text-2xl mt-1" />
